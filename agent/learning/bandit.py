...
DEFAULT_ARMS: list[GoalArm] = [
    ...
    GoalArm(
        ...
        description="Monitor global internet censorship and outages — OONI censorship measurements, RIPE Atlas probe connectivity, and anomaly aggregation to detect internet shutdowns, censorship escalation, and infrastructure failures",
        tools=["internet_outages", "web_search"],
        examples=[
            "Check OONI for internet censorship anomalies in Iran over last 7 days",
            "Monitor RIPE Atlas probe disconnect rate in Russia for infrastructure disruption",
            "Detect outage signals via OONI aggregation for web_connectivity in China",
