---
name: full-pipeline
description: Full pipeline: research → spec → implement → test → review → checkpoint. Automates the entire optimal workflow for a new feature. Use for a new non-trivial feature end-to-end: research, spec, implement, review, checkpoint.
