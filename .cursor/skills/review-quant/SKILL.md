---
name: review-quant
description: Review a quant module for numerical stability, correctness, edge cases, and test coverage. Use when reviewing agent/quant modules for numerical stability and tests.
