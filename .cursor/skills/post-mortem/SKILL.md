---
name: post-mortem
description: Post-mortem after a hard bug, failed approach, or wasted session. Capture what happened and what we learned. Use after a hard bug, failed approach, or unproductive session.
