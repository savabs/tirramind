---
name: spec-to-task
description: Convert a completed spec into an active task file with atomic, verifiable steps. Use when a spec is complete and needs an atomic tasks/active file.
