...
description: Turn a rough idea into a research/spec-ready plan without writing code. Use when the idea is fuzzy and needs decomposition before research or spec.
