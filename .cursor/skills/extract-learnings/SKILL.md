...
description: Extract and consolidate learnings from completed tasks and checkpoints into project memory. Use after completing features to mine tasks/done and update project memory.
...
Run: `python3 scripts/extract_patterns.py`
