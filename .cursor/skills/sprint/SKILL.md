---
name: sprint
description: Sprint mode: execute ALL remaining steps in the active task file sequentially without stopping between steps. Use to execute all remaining task steps in one run without pausing.
