...
class Trainer:
    ...
    def train(self) -> dict[str, list[float]]:
        ...
        for epoch in range(start_epoch, cfg.epochs):
            ...
            # Per-entity-type obs CE accumulator (for metrics.jsonl breakdown)
            ...
            for i in _window_iter:
                ...
                if len(obs_targets) > 0:
                    ...
                    if target_embs:
                        ...
                        # Always compute per-example CE (needed for entity-type
                        # breakdown in metrics.jsonl regardless of alignment weights)
                        ...
                        # Accumulate per-entity-type CE for metrics.jsonl
